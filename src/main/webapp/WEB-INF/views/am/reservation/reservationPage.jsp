	...
	<div id="tableDiv">
		...
		<div id="listDiv">
			<table style="margin-left: auto; margin-right: auto;">
				<tr><td class="reservationList"><a class="reservationList" href="#">이리온 동물병원</a></td></tr>
				<tr><td class="reservationList"><a class="reservationList" href="#">메디컬 최 동물병원</a></td></tr>
				<tr><td class="reservationList"><a class="reservationList" href="#">24시 메디컬센터</a></td></tr>
			</table>
		</div>
		
		<div id="detailDiv">
			<table class="reservationDetail">
				<tr><td>튼튼병원 상세 정보</td></tr>
				<tr><td><img src="/am/resources/img/medi.jpeg"></td></tr>
				<tr><td>이름 : 튼튼병원</td></tr>
				<tr><td>주소 : 서울시</td></tr>
				<tr><td>전화번호 : 010 - 0000 - 0000</td></tr>
				<tr><td><button type="button">예약</button></td></tr>
			</table>
		</div>
