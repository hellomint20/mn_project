...
public class NaverLoginBO {
	private final static String CLIENT_ID = "KNFKXNZUsAHZqRw9IT2E";
	private final static String CLIENT_SECRET = "f7E3PojvLJ";
	private final static String REDIRECT_URI = "http://localhost:8090/am/navercallback";
